...
# Transpose
cpuTime = cpuTime.transpose().rename(columns={4096: 'cpu4096', 16384: 'cpu16384', 65536: 'cpu65536', 1048576: 'cpu1048576'})
gpuTime = gpuTime.transpose().rename(columns={4096: 'gpu4096', 16384: 'gpu16384', 65536: 'gpu65536', 1048576: 'gpu1048576'})
tiledTime = tiledTime.transpose().rename(columns={4096: 'tiled4096', 16384: 'tiled16384', 65536: 'tiled65536', 1048576: 'tiled1048576'})
cublasTime = cublasTime.transpose().rename(columns={4096: 'cublas4096', 16384: 'cublas16384', 65536: 'cublas65536', 1048576: 'cublas1048576'})
